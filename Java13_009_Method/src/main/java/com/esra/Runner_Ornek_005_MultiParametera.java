...
public class Runner_Ornek_005_MultiParametera {
    public static void main(String[] args) {
        System.out.println(hangiSayiBuyuk(2,-90,76,3));
        System.out.println(hangiSayiBuyukAlt(2,-90,76,3));
    }//main sonu
    /**
    ...
    /**
     * DİKKAT!!!!
     * bir method içinde return işlemi o methodun sonlandığını bildirir.
     * bu neden o andan itibaren diğer kodlamalar işletilmez, method cevap vermiş sayılır.
     *
     */
