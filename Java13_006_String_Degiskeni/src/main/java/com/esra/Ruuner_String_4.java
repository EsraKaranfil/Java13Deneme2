...
public class Ruuner_String_4 {
    public static void main(String[] args) {
        /**
         * Bir ifade içinde geçebilecek olan kelimeleri ararken sadece varlıklarını
         * kontrol etmek için kullanabileceğimiz bir method
        ...
        /**
         * String ifadelerin belli kurallara göre bölünmesi gerekebilir. bunun için
         * string içinde bunu yapabileceğim bir method bulunmaktadır.
         * str.split(";")
         *
         */
